...
import com.java.travel_cross_platform_be.Config.CustomUserDetails;
...
public class AuthenServiceImpl implements AuthenService {
    ...
    public RegisterRes register(RegisterReq request) {
        ...
        Set<Role> roles = Set.of(Role.builder().name(ERole.valueOf("ROLE_USER")).build());
        user.setRoles(roles);  // Gán quyền cho người dùng
